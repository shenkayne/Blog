...
<div class="">
	<div class="headBack">
		<el-row class="container">
            ...
            <!--						<el-menu-item index="/Write"><i class="fa fa-wa fa-cny"></i> 写文章</el-menu-item>-->
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/baiyuekui.png)'}">
		<div class="scene">
<!--			<div><span id="luke"></span></div>-->
<!--      <div><span>欢迎</span></div>-->
		</div>
		<div class="h-information">

      <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'static/img/xiguatou.png'" alt="">

			<h2 class="h-description">
        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"小小西瓜博客平台，记录学习每一天"}}
      </h2>
		</div>
	</div>
</div>
