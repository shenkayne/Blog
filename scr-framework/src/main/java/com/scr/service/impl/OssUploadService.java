...
import com.scr.utils.PathUtils;
import lombok.Data;
...
//        String url = uploadFile(filePath,img.getInputStream());//七牛云  2099/2/3/wqeqeqe.png
    ...
    private String accessKey = "VgH7P9n00FIIm-VveTM_abxxLFd1YFJwf7629onc";
    private String secretKey = "aje24f3pqMkUVLU3mcEz3KORRBR3pD8xnEZS10bI";
    private String bucket = "scr-blog";
    ...
    private String uploadOss(MultipartFile imgFile, String filePath){
        ...
        try {
            ...
            try {
                ...
                return "http://rhgv24efk.bkt.clouddn.com/"+key;//测试域名
    ...
    private String uploadFile(String filePath, InputStream inputStream) {
        ...
        String endpoint = "oss-cn-zhejiang.aliyuncs.com";
        // 阿里云账号AccessKey拥有所有API的访问权限，风险很高。强烈建议您创建并使用RAM用户进行API访问或日常运维，请登录RAM控制台创建RAM用户。
        String accessKeyId = "VgH7P9n00FIIm-VveTM_abxxLFd1YFJwf7629onc";
        String accessKeySecret = "aje24f3pqMkUVLU3mcEz3KORRBR3pD8xnEZS10bI";
        String bucketName = "scr-blog";
        // 创建OSSClient实例。
