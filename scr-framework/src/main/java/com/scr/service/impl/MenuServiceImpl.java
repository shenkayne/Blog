...
import com.scr.mapper.MenuMapper;
...
//        List<Menu> menuTree = builderMenuTree(menus,0L);
        List<Menu> menuTree = builderMenuTree(menus,menus.get(0).getParentId());

        return menuTree;
    }

    @Override
    public ResponseResult pageMenuList( MenuListDto menuListDto) {
